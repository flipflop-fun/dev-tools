...
export default function SecretKeyTool() {
  ...
  const [copiedOutputSecret, setCopiedOutputSecret] = useState(false);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        {copiedInput && <div className="text-xs text-green-400">Copied!</div>}
      </div>
        ...
        <div className="space-y-2">
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                onClick={() => {
                  void navigator.clipboard
                    ...
                    .then(() => {
                      setCopiedOutputSecret(true);
                      setTimeout(() => setCopiedOutputSecret(false), 1500);
                    });
                }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
              ...
              {copiedOutputSecret && <div className="text-xs text-green-400">Copied!</div>}
            </div>
          </div>
          <div>
